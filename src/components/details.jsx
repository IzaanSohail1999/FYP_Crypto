    ...
    <div id='services' >
      <div className='container'>
        ...
        <div>
          ...
          <div className='service-desc'>
            <p>The approach we used to compare the two Approaches Wrapper and MDI are: </p>
            <p>1. Using MDI approach we proved better time efficiency in selecting features than the Wrapper Appraoch.</p>
            <p>2. Using MDI approach we automated the process of feature selection rather than selecting features manually like in Wrapper Appraoch.</p>
            <p>3. As visible in comparison graphs below the feature selection done by MDI trained a more accurate model than Wrapper Appraoch.</p>
            <p>4. We also tested our model on Ethereum and not just on Bitcoin.</p>
